...
class Step4 extends Component {
  ...
  change = (event, stateName, type, stateNameEqualTo) => {
    ...
    this.props.handelEndPointStateChange(stateName, event.target.value);
  };
  ...
  handleSelect = async selected => {
    ...
    this.props.handelEndPointStateChange('placeId', res[0].place_id);
  };
  ...
  handleDateChange = (date, stateName) => {
    ...
    this.props.handelEndPointStateChange(stateName, date);
  };
